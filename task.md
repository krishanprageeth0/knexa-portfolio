...
- [x] Implement `Magnetic.tsx` interactive physics wrapper
- [x] Implement `GridDivider.tsx` self-drawing blueprint lines
...
- [x] Refactor `src/App.tsx` to handle global scroll-driven coordinates and custom mouse glow
...
- [x] Create `Gallery.tsx` graphic design showcase (masonry layout + lightbox) with 23 assets mapped to my project/ folders, prioritizing Social Posts first and rendering 2 columns on mobile
